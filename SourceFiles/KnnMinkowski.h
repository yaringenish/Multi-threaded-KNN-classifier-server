...
#ifndef ADV_PROG_ASS2_KNNMINKOWSKI_H
#define ADV_PROG_ASS2_KNNMINKOWSKI_H
#include "Knn.h"
/**
 * This is the Knn Minkowski class, it finds the k closest vectors to the input vector
 * using the Minkowski distance calculate method.
 */
class KnnMinkowski : public Knn{
public:
    /**
     ...
     */
    KnnMinkowski(std:: vector<double> inputVector,std:: vector<std::pair< std::string,
...
#endif //ADV_PROG_ASS2_KNNMINKOWSKI_H
