...
#ifndef ADV_PROG_ASS2_KNNCHEBYSHEV_H
#define ADV_PROG_ASS2_KNNCHEBYSHEV_H

#include "Knn.h"
/**
 * This is the Knn Chebyshev class, it finds the k closest vectors to the input vector
 * using the Chebyshev distance calculate method.
 */
class KnnChebyshev : public Knn{
public:
    /**
     ...
     */
    KnnChebyshev(std:: vector<double> inputVector,std:: vector<std::pair< std::string,
            std:: vector<double> > > vectors, int k,int vectorSize);
    /**
     * This method calculates the distance using the Chebyshev calculation.
...
#endif //ADV_PROG_ASS2_KNNCHEBYSHEV_H
